                        ...
                        >
                            <input
                                ...
                                placeholder={
                                    ...
                                    MODAL_DEFAULTS.beginTrial.landing
                                        .fieldPlaceholder
                                }
                                style={{
                                    width: "100%",
            ...
            >
                <div className="modal-right" style={{ width: "100%" }}>
                    <MainBody
                        ...
                        button={null}
                        onCloseModal={() =>
                            console.log("cant close... claiming.")
                        }
                    />
                </div>
            </div>
        ...
        >
            <div className="modal-right" style={{ width: "100%" }}>
                <MainBody
                    ...
                    button={null}
                    onCloseModal={() => {
                        let urlToRedirectTo = `${redirectUrlBase}${accountId}${delimiter}${secretKey}${
                            includedCid !== undefined
                                ? `?cid=${includedCid}`
                                : ""
                        }`;
                        console.log("url to redirect to: ", urlToRedirectTo);
                        localStorage.setItem(
                            `${KEYPOM_LOCAL_STORAGE_KEY}:urlToRedirectTo`,
                            urlToRedirectTo
                        );
