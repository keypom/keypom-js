...
test('NFT drop', async (t) => {
    ...
    const numKeys = 1;
    const usesPerKey = 350;
    const masterKey = "asldkjalsdkjasldjsad";
    
    const nftTitle = "St. Rita of Cascia High School NFT";
    const nftDescription = "Maximizing Your NIL Potential: Social Media Hygene for Student-Athletes";
    const nftMediaIPFSHash = "bafybeiehk3mzsj2ih4u4fkvmkfrome3kars7xyy3bxh6xfjquws4flglqa";
            ...
            methods: [[
                {
                    ...
                    attachedDeposit: parseNearAmount("0.009")
                }
            ]]
        }
    })
