...
const FastAuthModal = ({ selector, options, isVisible, onClose, walletSelectorModal, }) => {
    ...
    if (!isVisible)
        return null;
    return ((0, jsx_runtime_1.jsx)("div", { className: `fastauth-modal-wrapper ${options.theme === "dark" ? "dark-theme" : ""}`, children: (0, jsx_runtime_1.jsxs)("div", { className: "fastauth-modal", children: [(0, jsx_runtime_1.jsxs)("div", { className: "fastauth-modal-header", children: [(0, jsx_runtime_1.jsx)("h3", { children: "Login or sign up" }), (0, jsx_runtime_1.jsx)("button", { className: "fastauth-close-button", onClick: handleClose, children: (0, jsx_runtime_1.jsx)(CloseIcon_1.CloseIcon, {}) })] }), (0, jsx_runtime_1.jsx)("div", { className: "fastauth-modal-body", children: loading ? ((0, jsx_runtime_1.jsx)("div", { className: "fastauth-loading-indicator", children: (0, jsx_runtime_1.jsx)(react_spinners_1.ClipLoader, { color: "#5f8afa", loading: loading, size: 50 }) })) : ((0, jsx_runtime_1.jsx)("div", { className: "fastauth-content", children: iframeVisible && publicKeyString ? ((0, jsx_runtime_1.jsx)("iframe", { src: `${constants_1.AUTH_ORIGIN}/index.html?publicKey=${encodeURIComponent(publicKeyString)}&appId=${encodeURIComponent(appId)}`, title: "Authentication", className: "fastauth-auth-iframe", sandbox: "allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox" })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("button", { className: "social-login-button", onClick: handleSignInClick, children: [(0, jsx_runtime_1.jsx)(GoogleIcon_1.default, { className: "social-login-icon" }), (0, jsx_runtime_1.jsx)("span", { children: "Social Login" })] }), (0, jsx_runtime_1.jsxs)("button", { className: "wallet-signin-button", onClick: handleWalletSignIn, children: [(0, jsx_runtime_1.jsx)(WalletIcon_1.default, { className: "wallet-icon" }), (0, jsx_runtime_1.jsx)("span", { children: "Existing Wallet" })] })] })) })) })] }) }));
};
