...
const dropInfo = {
	...
	25: " ",
	25: "😃",
	25: "This is a really long title that is repeated. This is a really long title that is repeated. This is a really long title that is repeated. This is a really long title that is repeated. This is a really long title that is repeated. This is a really long title that is repeated. This is a really long title that is repeated. This is a really long title that is repeated. This is a really long title that is repeated. This is a really long title that is repeated.",
	25: "s",
	25: "This is a duplicate drop title",
	25: "This is a duplicate drop title",
	25: "This is a duplicate drop title",
	25: "This is a duplicate drop title",
...
test('token drops', async (t) => {
	// Loop through entries in dropInfo
	for (const [numKeys, dropName] of Object.entries(dropInfo)) {
	...
	const keysToClaim = keys.secretKeys.sort(() => Math.random() - 0.5).slice(0, 15);
