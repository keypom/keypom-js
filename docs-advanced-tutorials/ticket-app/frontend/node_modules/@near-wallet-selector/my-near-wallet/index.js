...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$h(fn = input.toString) && !isObject$6(val = call$g(fn, input))) return val;
  if (isCallable$h(fn = input.valueOf) && !isObject$6(val = call$g(fn, input))) return val;
  if (pref !== 'string' && isCallable$h(fn = input.toString) && !isObject$6(val = call$g(fn, input))) return val;
