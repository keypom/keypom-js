...
var connectNear = require('@nightlylabs/connect-near');
...
var getIterator$1 = function (argument, usingIterator) {
  ...
  if (aCallable$2(iteratorMethod)) return anObject$7(call$8(iteratorMethod, argument));
...
const setupNightlyConnectState = () => {
  return {
    client: null,
    modal: new connectNear.NightlyConnectModal(),
    accounts: []
  };
};
...
const NightlyConnect = ({
  ...
  const signer = {
    ...
    signMessage: (message, accountId) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        const tx = nearApiJs.transactions.Transaction.decode(Buffer.from(message)); // @ts-ignore
  ...
  const signOut = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    connectNear.clearPersistedSessionId();
    connectNear.clearPersistedSessionPublicKey();
    connectNear.clearPersistedSessionAccountId();
    ...
    signIn({
      ...
      return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
          ...
          let persistedId = connectNear.getPersistedSessionId();
          const persistedPubkey = connectNear.getPersistedSessionPublicKey();
          const persistedAccountId = connectNear.getPersistedSessionAccountId();
          ...
          try {
            connectNear.AppNear.build(Object.assign(Object.assign({}, params), {
              onUserConnect: account => {
                connectNear.setPersistedSessionPublicKey(account.publicKey.toString());
                connectNear.setPersistedSessionAccountId(account.accountId.toString());
              ...
              if (params.appMetadata.persistent !== false && persistedId === client.sessionId && persistedPubkey !== null && persistedAccountId !== null) {
                _state.accounts.push({
                  ...
                  publicKey: nearApiJs.utils.PublicKey.from(persistedPubkey)
                });
                ...
                if (qrCodeModal) {
                  _state.modal.openModal(client.sessionId, connectNear.NETWORK.NEAR);

                  _state.modal.onClose = () => {
                    reject(new Error("User cancelled pairing"));
                  };
                } else {
                  const uri = `nightlyconnect:${client.sessionId}?network=${connectNear.NETWORK.NEAR}`;
                  emitter.emit("uriChanged", {
                    uri
                  });
                }
              }
