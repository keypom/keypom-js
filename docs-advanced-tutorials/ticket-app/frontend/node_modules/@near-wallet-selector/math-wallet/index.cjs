...
const MathWallet = ({
  ...
  const getAccounts = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return [{
      ...
      publicKey: (yield _state.wallet.signer.getPublicKey(account.accountId, options.network.networkId)).toString()
    }];
  });
