...
const Sender = ({
  ...
  const getAccounts = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const account = _state.wallet.account(); // When wallet is locked signer is empty an object {}.
...
function setupSender({
  ...
  return () => __awaiter(this, void 0, void 0, function* () {
    ...
    const installed = yield isInstalled(); // Add extra wait to ensure Sender's sign in status is read from the
