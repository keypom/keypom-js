...
import type { SignedTransaction as NearSignedTransaction, Transaction as NearTransaction } from "near-api-js/lib/transaction";
...
export interface NearNightly {
    ...
    connect: (onAccountChange?: (acc?: NightlyAccount) => void, eagerConnect?: boolean) => Promise<NightlyAccount>;
