...
const Nightly = ({
  ...
  const _state = yield setupNightlyState(store, emitter);
  ...
  return {
    signIn() {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _state.wallet.connect(newAcc => {
          if (!newAcc) {
            emitter.emit("signedOut", null);
          } else {
            emitter.emit("accountsChanged", {
    ...
    importAccountsInSecureContext(params) {
      return __awaiter(this, void 0, void 0, function* () {
