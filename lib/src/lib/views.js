...
*/
export const getKeyBalance = ({ publicKey, secretKey }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (secretKey) {
        publicKey = yield getPubFromSecret(secretKey);
    }
    return keypomView({
 ...
 * @group View Functions
*/
export const getKeyTotalSupply = () => __awaiter(void 0, void 0, void 0, function* () {
    return keypomView({
 ...
 * @group View Functions
*/
export const getKeys = ({ start, limit }) => __awaiter(void 0, void 0, void 0, function* () {
    return keypomView({
        methodName: 'get_keys',
        args: {
 ...
 * @group View Functions
*/
export const getKeyInformation = ({ publicKey, secretKey }) => __awaiter(void 0, void 0, void 0, function* () {
    // Assert that either a secretKey or public key is passed in
    assert(secretKey || publicKey, 'Must pass in either a publicKey or a secretKey');
    if (secretKey) {
        publicKey = yield getPubFromSecret(secretKey);
 ...
 * @group View Functions
*/
export const getKeyInformationBatch = ({ publicKeys, secretKeys }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (secretKeys) {
        ...
        publicKeys = yield Promise.all(secretKeys.map((secretKey) => __awaiter(void 0, void 0, void 0, function* () { return yield getPubFromSecret(secretKey); })));
    }
    return keypomView({
 ...
 * @group View Functions
*/
export const getDropInformation = ({ dropId, secretKey, publicKey, withKeys = false }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (withKeys) {
        dropInfo.keys = yield keypomView({
 ...
 * @group View Functions
*/
export const getKeySupplyForDrop = ({ dropId }) => __awaiter(void 0, void 0, void 0, function* () {
    return keypomView({
 ...
 * @group View Functions
*/
export const getKeysForDrop = ({ dropId, start, limit }) => __awaiter(void 0, void 0, void 0, function* () {
    return keypomView({
        methodName: 'get_keys_for_drop',
        args: {
            drop_id: dropId,
 ...
 * @group View Functions
*/
export const getDropSupplyForOwner = ({ accountId, }) => __awaiter(void 0, void 0, void 0, function* () {
    return keypomView({
 ...
 * @group View Functions
*/
export const getDrops = ({ accountId, start, limit, withKeys = false, }) => __awaiter(void 0, void 0, void 0, function* () {
    const drops = yield keypomView({
 ...
 * @group View Functions
*/
export const getNftSupplyForDrop = ({ dropId }) => __awaiter(void 0, void 0, void 0, function* () {
    return keypomView({
 ...
 * @group View Functions
*/
export const getNftTokenIDsForDrop = ({ dropId, start, limit }) => __awaiter(void 0, void 0, void 0, function* () {
    return keypomView({
 ...
 * @group View Functions
*/
export const getUserBalance = ({ accountId }) => __awaiter(void 0, void 0, void 0, function* () {
    return keypomView({
 ...
 * @group View Functions
 */
export const getCurMethodData = ({ secretKey, publicKey, keyUse }) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const keyInfo = yield getKeyInformation({ publicKey, secretKey });
    const dropInfo = yield getDropInformation({ publicKey, secretKey });
    assert(dropInfo.fc, 'No FC drop found');
    let methodDataArray = dropInfo.fc.methods;
    let startingIdx = methodDataArray.length > 1 ? (((_a = dropInfo.config) === null || _a === void 0 ? void 0 : _a.uses_per_key) || 1) - keyInfo.remaining_uses : 0;
    if (keyUse) {
 ...
 * @group View Functions
*/
export const canUserAddKeys = ({ dropId, accountId }) => __awaiter(void 0, void 0, void 0, function* () {
    assert(dropId && accountId, 'Must pass in a drop ID and account ID');
    const canAddKeys = yield keypomView({
 ...
 * @group View Functions
*/
export const getContractSourceMetadata = () => __awaiter(void 0, void 0, void 0, function* () {
    return keypomView({
