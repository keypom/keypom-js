 ...
 * @group Utility
 */
export const getPubFromSecret = (secretKey) => __awaiter(void 0, void 0, void 0, function* () {
    var keyPair = yield KeyPair.fromString(secretKey);
 ...
 * @group Utility
 */
export const accountExists = (accountId) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @group Utility
 */
export const getNFTMetadata = ({ contractId, tokenId }) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @group Utility
 */
export const getFTMetadata = ({ contractId }) => __awaiter(void 0, void 0, void 0, function* () {
    const { near, viewCall } = getEnv();
    const res = yield viewCall({
        contractId,
 ...
 * @group Utility
*/
export const createNFTSeries = ({ account, wallet, dropId, metadata, royalty }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return execute({ account: account, transactions: [tx] });
});
/**
 ...
 * @group Utility
 */
export const formatLinkdropUrl = ({ claimPage, networkId, contractId, secretKeys, baseUrl }) => {
 ...
 * @group Utility
 */
export const hashPassword = (str, fromHex = false) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @group Utility
 */
export const generateKeys = ({ numKeys, rootEntropy, metaEntropy, autoMetaNonceStart }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let i = 0; i < numKeys; i++) {
        if (rootEntropy) {
            ...
            var keyPair = yield KeyPair.fromRandom('ed25519');
            keyPairs.push(keyPair);
...
export const keypomView = ({ methodName, args }) => __awaiter(void 0, void 0, void 0, function* () {
...
// }
/** @group Utility */
export const execute = ({ transactions, account, wallet, fundingAccount, successUrl, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (wallet) {
        ...
        if (needsRedirect)
            return yield wallet.signAndSendTransactions({ transactions, callbackUrl: successUrl });
    ...
    return yield signAndSendTransactions(nearAccount, transformTransactions(transactions));
});
/**
...
*/
export const ftTransferCall = ({ account, wallet, contractId, absoluteAmount, amount, dropId, returnTransaction = false, }) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @group Registering Key Uses
*/
export const nftTransferCall = ({ account, wallet, contractId, tokenIds, dropId, returnTransactions = false, }) => __awaiter(void 0, void 0, void 0, function* () {
...
export const parseFTAmount = (amt, decimals) => {
...
/** @group Utility */
export const getStorageBase = ({ public_keys, deposit_per_use, drop_id, config, metadata, simple, ft, nft, fc, passwords_per_use }) => {
...
export const estimateRequiredDeposit = ({ near, depositPerUse, numKeys, usesPerKey, attachedGas, storage = parseNearAmount("0.034"), keyStorage = parseNearAmount("0.0065"), fcData, ftData, }) => __awaiter(void 0, void 0, void 0, function* () {
    const numKeysBN = new BN(numKeys.toString());
    const usesPerKeyBN = new BN(usesPerKey.toString());
...
const getFtCosts = (near, numKeys, usesPerKey, ftContract) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { min } = yield viewAccount.viewFunction(ftContract, "storage_balance_bounds", {});
    // console.log('storageBalanceBounds: ', storageBalanceBounds)
    let costs = new BN(min).mul(new BN(numKeys)).mul(new BN(usesPerKey)).add(new BN(min));
 ...
 * @group Utility
 */
export function generatePerUsePasswords({ publicKeys, uses, basePassword }) {
...
//# sourceMappingURL=keypom-utils.js.map