...
var getDropInformation = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _c, viewAccount, contractId, keyPair, dropInfo, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, near_api_js_1.KeyPair.fromString(secretKey)];
                case 1:
                    keyPair = _e.sent();
                    publicKey = keyPair.getPublicKey().toString();
                    _e.label = 2;
                case 2: return [4 /*yield*/, viewAccount.viewFunction2({
