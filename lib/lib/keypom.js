...
exports.deleteDrops = exports.deleteKeys = exports.createAccountAndClaim = exports.claim = exports.getDrops = exports.addKeys = exports.createDrop = exports.initKeypom = void 0;
...
var addKeys = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var required_gas, deposit_per_use, uses_per_key, requiredDeposit, transactions;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    required_gas = drop.required_gas, deposit_per_use = drop.deposit_per_use, uses_per_key = drop.config.uses_per_key;
                    return [4 /*yield*/, (0, keypom_utils_1.estimateRequiredDeposit)({
                            near: near,
...
exports.claim = claim;
var createAccountAndClaim = function (_a) {
    var newAccountId = _a.newAccountId, newPublicKey = _a.newPublicKey, secretKey = _a.secretKey;
    var keyPair = KeyPair.fromString(secretKey);
    keyStore.setKey(networkId, contractId, keyPair);
    var transactions = [{
            receiverId: receiverId,
...
exports.createAccountAndClaim = createAccountAndClaim;
