...
var near, connection, logger, fundingAccount, viewAccount, fundingKey;
...
var claim = function (_a) {
    var account = _a.account, wallet = _a.wallet, receiverId = _a.receiverId;
    var transactions = [{
            receiverId: 'v1.keypom.testnet',
            actions: [{
                    type: 'FunctionCall',
    ...
    return execute({ transactions: transactions, account: account, wallet: wallet });
};
exports.claim = claim;
