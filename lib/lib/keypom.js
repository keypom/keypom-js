...
exports.deleteDrops = exports.getDrops = exports.createDrop = exports.initKeypom = void 0;
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            if (funder) {
                ...
                fundingAccount.signAndSendTransactions = function (transactions) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, Promise.all(transactions.map(function (tx) { return fundingAccount.signAndSendTransaction(tx); }))];
...
var createDrop = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var keyPairs, pubKeys, i, keyPair, finalConfig, requiredDeposit, transactions, responses, _c, _d, responses;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 5:
                    ...
                    if (!fundingAccount) return [3 /*break*/, 8];
                    _d = (_c = fundingAccount).signAndSendTransactions;
                ...
                case 8:
                    ...
                    return [4 /*yield*/, wallet.signAndSendTransactions({
                            transactions: [{
                                    receiverId: 'v1.keypom.testnet',
                                    actions: [{
                                            type: 'FunctionCall',
                                    ...
                                    case 0:
                                        ...
                                        actions.push({
                                            ...
                                            params: {
                                                ...
                                                args: {
                                                    drop_id: drop_id,
                                                    public_keys: keys.map(function (_a) {
                                                        var pk = _a.pk;
                                                        return pk;
                                                    }),
                                                },
                                        ...
                                        _c = (_b = fundingAccount).signAndSendTransactions;
