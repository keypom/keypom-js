...
exports.deleteDrops = exports.getDrops = exports.addKeys = exports.createDrop = exports.initKeypom = void 0;
...
var addKeys = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    requiredDeposit = parseNearAmount((0.01 * publicKeys.length).toString());
                    transactions = [{
                            receiverId: 'v1.keypom.testnet',
                            actions: [{
                                    type: 'FunctionCall',
