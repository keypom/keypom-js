...
exports.claim = exports.deleteDrops = exports.deleteKeys = exports.getDrops = exports.addKeys = exports.createDrop = exports.initKeypom = exports.getEnv = void 0;
...
/// for testing
var FT_CONTRACT_ID = 'ft.keypom.testnet';
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 5:
                    requiredDeposit = _d.sent();
                    activeAccount = getAccount({ account: account, wallet: wallet });
                    transactions = [];
                    if (!ftData.contractId) return [3 /*break*/, 7];
                            ...
                            actions: [{
                                    ...
                                    params: {
                                        ...
                                        args: {
                                            ...
                                            amount: new bn_js_1.default(ftData.balancePerUse).mul(new bn_js_1.default(numKeys || '1')).toString(),
                                            msg: dropId.toString(),
                                        },
                                        gas: '50000000000000',
                                        deposit: '1',
...
var addKeys = function (_a) {
    var account = _a.account, wallet = _a.wallet, drop = _a.drop, publicKeys = _a.publicKeys;
    return __awaiter(void 0, void 0, void 0, function () {
        var required_gas, deposit_per_use, uses_per_key, _b, ft_data, requiredDeposit, transactions;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    required_gas = drop.required_gas, deposit_per_use = drop.deposit_per_use, uses_per_key = drop.config.uses_per_key, _b = drop.ft_data, ft_data = _b === void 0 ? {} : _b;
                    return [4 /*yield*/, (0, keypom_utils_1.estimateRequiredDeposit)({
                            near: near,
