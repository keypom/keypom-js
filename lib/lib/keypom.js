...
exports.claim = exports.deleteDrops = exports.deleteKeys = exports.getDrops = exports.addKeys = exports.createDrop = exports.initKeypom = exports.execute = exports.getEnv = void 0;
...
var getAccount = function (_a) {
    ...
    return account || wallet || fundingAccount;
};
...
var createDrop = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var keyPairs, pubKeys, i, keyPair, finalConfig, requiredDeposit, transactions, responses, tokenIds, nftResponses;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, exports.execute)({ transactions: transactions, account: account, wallet: wallet })];
                case 6:
                    responses = _e.sent();
...
var addKeys = function (_a) {
    var account = _a.account, wallet = _a.wallet, drop = _a.drop, publicKeys = _a.publicKeys, nftTokenIds = _a.nftTokenIds;
    return __awaiter(void 0, void 0, void 0, function () {
        var numKeys, drop_id, registered_uses, required_gas, deposit_per_use, uses_per_key, _b, _c, ftData, _d, nftData, requiredDeposit, transactions, responses, nftResponses;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    numKeys = publicKeys.length;
                    drop_id = drop.drop_id, registered_uses = drop.registered_uses, required_gas = drop.required_gas, deposit_per_use = drop.deposit_per_use, uses_per_key = drop.config.uses_per_key, _b = drop.drop_type, _c = _b.FungibleToken, ftData = _c === void 0 ? {} : _c, _d = _b.NonFungibleToken, nftData = _d === void 0 ? {} : _d;
                    return [4 /*yield*/, (0, keypom_utils_1.estimateRequiredDeposit)({
                            near: near,
...
var deleteKeys = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            return [2 /*return*/, (0, exports.execute)({ transactions: transactions, account: account, wallet: wallet })];
        });
    });
};
...
var claim = function (_a) {
    ...
    return (0, exports.execute)({ transactions: transactions, account: contractAccount });
};
exports.claim = claim;
