...
exports.updateKeypomContractId = exports.updateFunder = exports.initKeypom = exports.execute = exports.getEnv = exports.supportedLinkdropClaimPages = exports.supportedKeypomContracts = exports.networks = void 0;
            ...
            switch (_c.label) {
                case 0:
                    ...
                    if (_near) {
                        ...
                        networkConfig = typeof network === 'string' ? exports.networks[network] : network;
                        ...
                        near = new near_api_js_1.Near(__assign(__assign({}, networkConfig), { keyStore: keyStore }));
                    }
                    ...
                    viewAccount = new near_api_js_1.Account(connection, exports.networks[networkId].viewAccountId);
