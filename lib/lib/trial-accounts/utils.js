...
var generateExecuteArgs = function (_a) {
    ...
    var totalGasBN = new bn_js_1.default(0);
    var totalDepositsBN = new bn_js_1.default(0);
    var executeArgs = {
        transactions: []
    };
...
var hasEnoughBalance = function (_a) {
    var trialAccountId = _a.trialAccountId, totalGasForTxns = _a.totalGasForTxns, totalAttachedYocto = _a.totalAttachedYocto;
    return __awaiter(void 0, void 0, void 0, function () {
        var near, trialAccountObj, accountState, storageCostPerByte, totalStorage, availAmount, yoctoPerGas, gasCost, totalCost;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    near = (0, keypom_1.getEnv)().near;
                    trialAccountObj = new near_api_js_1.Account(near.connection, trialAccountId);
                    return [4 /*yield*/, trialAccountObj.state()];
                case 1:
                    accountState = _b.sent();
                    storageCostPerByte = new bn_js_1.default('10000000000000000000');
                    totalStorage = new bn_js_1.default(accountState.storage_usage).mul(storageCostPerByte);
                    availAmount = new bn_js_1.default(accountState.amount).sub(totalStorage);
                    yoctoPerGas = 100000000;
                    gasCost = new bn_js_1.default(totalGasForTxns).mul(new bn_js_1.default(yoctoPerGas));
                    totalCost = gasCost.add(new bn_js_1.default(totalAttachedYocto));
                    return [2 /*return*/, availAmount.gte(totalCost)];
            }
        });
    });
};
