        ...
        return __generator(this, function (_x) {
            switch (_x.label) {
                ...
                case 1:
                    ...
                    (0, checks_1.assert)(callableMethods.length === callableContracts.length && callableMethods.length === (maxAttachableNEARPerContract || maxAttachableYoctoPerContract).length, 'The length of the callable methods, contracts, and max attachable deposit per contract must all be the same.');
                ...
                case 7:
                    ...
                    if (maxAttachableNEARPerContract) {
                        maxAttachableYoctoPerContract = maxAttachableNEARPerContract.map(function (deposit) {
                            if (deposit == "*")
                                return "*";
                    ...
                    rootReceiverId = (_w = finalConfig.root_account_id) !== null && _w !== void 0 ? _w : (networkId == "testnet" ? "testnet" : "near");
                    ...
                    storageCost = parseNearAmount("0.3");
                    attachedDeposit = new bn_js_1.default(startingBalanceYocto).add(new bn_js_1.default(storageCost)).toString();
                    trialEndFloorYocto = new bn_js_1.default(attachedDeposit).sub(new bn_js_1.default(trialEndFloorYocto)).toString();
                    actualContracts = callableContracts.join(",");
                    actualAmounts = maxAttachableYoctoPerContract.join(",");
                    actualMethods = callableMethods.map(function (method) { return method.join(":"); }).join(",");
                    createDropArgs = {
                        drop_id: dropId,
...
var claimTrialAccountDrop = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _b, networkId, keyStore, contractId, contractAccount, receiverId, execute, fundingAccountDetails, near, keyPair, pubKey, dropInfo, attachedGas, userFcArgs, transactions, result;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _b = (0, keypom_1.getEnv)(), networkId = _b.networkId, keyStore = _b.keyStore, contractId = _b.contractId, contractAccount = _b.contractAccount, receiverId = _b.receiverId, execute = _b.execute, fundingAccountDetails = _b.fundingAccountDetails, near = _b.near;
                ...
                case 2:
                    ...
                    attachedGas = dropInfo.required_gas;
                    userFcArgs = {
