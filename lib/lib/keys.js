...
var addKeys = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _d, near, gas, contractId, receiverId, getAccount, execute, fundingAccountDetails, networkId, _e, drop_id, owner_id, registered_uses, required_gas, deposit_per_use, config, ftData, nftData, fcData, next_key_id, _f, uses_per_key, keys, rootEntropyUsed, nonceDropIdMeta, passwords, camelFTData, camelFCData, requiredDeposit, hasBalance, userBal, transactions, _g, _h, tokenIds, nftTXs, responses;
        return __generator(this, function (_j) {
            switch (_j.label) {
                ...
                case 13:
                    ...
                    if (!(ftData === null || ftData === void 0 ? void 0 : ftData.contract_id)) return [3 /*break*/, 15];
