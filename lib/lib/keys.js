...
var addKeys = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _c, near, gas, contractId, receiverId, getAccount, execute, fundingAccountDetails, _d, drop_id, owner_id, registered_uses, required_gas, deposit_per_use, uses_per_key, _e, ftData, _f, nftData, fcData, next_key_id, _g, keys, rootEntropyUsed, nonceDropIdMeta, passwords, camelFTData, camelFCData, requiredDeposit, hasBalance, userBal, transactions, _h, _j, responses, nftResponses;
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 15:
                    responses = _k.sent();
                    if (!(nftTokenIds && nftTokenIds.length > 0)) return [3 /*break*/, 17];
                ...
                case 16:
                    nftResponses = _k.sent();
                    responses = responses.concat(nftResponses);
                    _k.label = 17;
                case 17: return [2 /*return*/, { responses: responses, dropId: drop_id, keys: keys }];
            }
        });
    });
};
