...
var addKeys = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _c, near, gas, contractId, receiverId, getAccount, execute, fundingAccountDetails, _d, drop_id, registered_uses, required_gas, deposit_per_use, uses_per_key, _e, ftData, _f, nftData, fcData, next_key_id, _g, keys, rootEntropyUsed, nonceDropIdMeta, passwords, camelFTData, camelFCData, requiredDeposit, hasBalance, userBal, transactions, responses, nftResponses;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 1:
                    ...
                    _h.label = 2;
                case 2:
                    _d = _g, drop_id = _d.drop_id, registered_uses = _d.registered_uses, required_gas = _d.required_gas, deposit_per_use = _d.deposit_per_use, uses_per_key = _d.config.uses_per_key, _e = _d.ft, ftData = _e === void 0 ? {} : _e, _f = _d.nft, nftData = _f === void 0 ? {} : _f, fcData = _d.fc, next_key_id = _d.next_key_id;
                    ...
                    if (ftData.contract_id) {
                        transactions.push((0, keypom_utils_1.ftTransferCall)({
                            ...
                            args: {
                                ...
                                amount: new bn_js_1.default(ftData.balance_per_use).mul(new bn_js_1.default(numKeys)).mul(new bn_js_1.default(uses_per_key)).toString(),
                ...
                case 13:
                    responses = _h.sent();
                    if (!(nftTokenIds && nftTokenIds.length > 0)) return [3 /*break*/, 15];
                ...
                case 14:
                    ...
                    _h.label = 15;
                case 15: return [2 /*return*/, { responses: responses, dropId: drop_id, keys: keys }];
            }
        });
    });
};
