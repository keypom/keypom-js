...
var addKeys = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _d, near, gas, contractId, receiverId, getAccount, execute, fundingAccountDetails, networkId, _e, drop_id, owner_id, registered_uses, required_gas, deposit_per_use, config, ftData, nftData, fcData, next_key_id, _f, uses_per_key, canAddKeys, keys, rootEntropyUsed, nonceDropIdMeta, passwords, camelFTData, camelFCData, requiredDeposit, hasBalance, userBal, _g, transactions, _h, _j, tokenIds, nftTXs, responses;
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 14:
                    ...
                    _g = bn_js_1.default.bind;
                    return [4 /*yield*/, (0, views_1.getUserBalance)({ accountId: account.accountId })];
                case 15:
                    userBal = new (_g.apply(bn_js_1.default, [void 0, _k.sent()]))();
