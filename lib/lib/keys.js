...
var addKeys = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _b, near, fundingAccount, fundingKey, gas, attachedGas, contractId, receiverId, getAccount, execute, numKeys, drop_id, registered_uses, required_gas, deposit_per_use, uses_per_key, _c, _d, ftData, _e, nftData, requiredDeposit, transactions, responses, nftResponses;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    _b = (0, keypom_1.getEnv)(), near = _b.near, fundingAccount = _b.fundingAccount, fundingKey = _b.fundingKey, gas = _b.gas, attachedGas = _b.attachedGas, contractId = _b.contractId, receiverId = _b.receiverId, getAccount = _b.getAccount, execute = _b.execute;
                    numKeys = publicKeys.length;
                    drop_id = drop.drop_id, registered_uses = drop.registered_uses, required_gas = drop.required_gas, deposit_per_use = drop.deposit_per_use, uses_per_key = drop.config.uses_per_key, _c = drop.drop_type, _d = _c.ft, ftData = _d === void 0 ? {} : _d, _e = _c.nft, nftData = _e === void 0 ? {} : _e;
...
var deleteKeys = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _c, near, fundingAccount, fundingKey, gas, attachedGas, contractId, receiverId, getAccount, execute, drop_id, registered_uses, actions, transactions;
        return __generator(this, function (_d) {
            _c = (0, keypom_1.getEnv)(), near = _c.near, fundingAccount = _c.fundingAccount, fundingKey = _c.fundingKey, gas = _c.gas, attachedGas = _c.attachedGas, contractId = _c.contractId, receiverId = _c.receiverId, getAccount = _c.getAccount, execute = _c.execute;
