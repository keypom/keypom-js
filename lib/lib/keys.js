...
var addKeys = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _c, near, gas, contractId, receiverId, getAccount, execute, fundingAccountDetails, _d, drop_id, registered_uses, required_gas, deposit_per_use, uses_per_key, _e, ftData, _f, nftData, fcData, next_key_id, _g, keys, rootEntropyUsed, nonceDropIdMeta, passwords, requiredDeposit, hasBalance, userBal, transactions, responses, nftResponses;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 8:
                    ...
                    passwords = _h.sent();
                    _h.label = 9;
                case 9: return [4 /*yield*/, (0, keypom_utils_1.estimateRequiredDeposit)({
                        near: near,
