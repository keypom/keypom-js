 ...
 * @param {boolean=} returnTransactions (OPTIONAL) If true, the transaction will be returned instead of being signed and sent.
 *
...
var addKeys = function (_a) {
    var account = _a.account, wallet = _a.wallet, dropId = _a.dropId, drop = _a.drop, numKeys = _a.numKeys, publicKeys = _a.publicKeys, nftTokenIds = _a.nftTokenIds, rootEntropy = _a.rootEntropy, basePassword = _a.basePassword, passwordProtectedUses = _a.passwordProtectedUses, _b = _a.useBalance, useBalance = _b === void 0 ? false : _b, _c = _a.returnTransactions, returnTransactions = _c === void 0 ? false : _c;
    return __awaiter(void 0, void 0, void 0, function () {
        var _d, near, gas, contractId, receiverId, getAccount, execute, fundingAccountDetails, _e, drop_id, owner_id, registered_uses, required_gas, deposit_per_use, uses_per_key, _f, ftData, _g, nftData, fcData, next_key_id, _h, keys, rootEntropyUsed, nonceDropIdMeta, passwords, camelFTData, camelFCData, requiredDeposit, hasBalance, userBal, transactions, _j, _k, tokenIds, nftTXs, responses;
        return __generator(this, function (_l) {
            switch (_l.label) {
                case 0:
                    _d = (0, keypom_1.getEnv)(), near = _d.near, gas = _d.gas, contractId = _d.contractId, receiverId = _d.receiverId, getAccount = _d.getAccount, execute = _d.execute, fundingAccountDetails = _d.fundingAccountDetails;
                ...
                case 2:
                    ...
                    _l.label = 3;
                case 3:
                    _e = _h, drop_id = _e.drop_id, owner_id = _e.owner_id, registered_uses = _e.registered_uses, required_gas = _e.required_gas, deposit_per_use = _e.deposit_per_use, uses_per_key = _e.config.uses_per_key, _f = _e.ft, ftData = _f === void 0 ? {} : _f, _g = _e.nft, nftData = _g === void 0 ? {} : _g, fcData = _e.fc, next_key_id = _e.next_key_id;
                    dropId = drop_id;
                    (0, checks_1.assert)(owner_id === account.accountId, 'You are not the owner of this drop. You cannot add keys to it.');
                    if (!!publicKeys) return [3 /*break*/, 8];
                    ...
                    if (!rootEntropyUsed) return [3 /*break*/, 5];
                ...
                case 4:
                    keys = _l.sent();
                    return [3 /*break*/, 7];
                case 5: return [4 /*yield*/, (0, keypom_utils_1.generateKeys)({
                        numKeys: numKeys,
                    })];
                case 6:
                ...
                case 8:
                    ...
                    if (!basePassword) return [3 /*break*/, 10];
                ...
                case 13:
                    ...
                    if (!ftData.contract_id) return [3 /*break*/, 15];
