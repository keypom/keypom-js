        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    drop_id = drop.drop_id, registered_uses = drop.registered_uses, required_gas = drop.required_gas, deposit_per_use = drop.deposit_per_use, uses_per_key = drop.config.uses_per_key, _c = drop.drop_type, _d = _c.FungibleToken, ftData = _d === void 0 ? {} : _d, _e = _c.NonFungibleToken, nftData = _e === void 0 ? {} : _e;
...
var deleteKeys = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _b, near, fundingAccount, fundingKey, gas, attachedGas, contractId, receiverId, getAccount, execute, drop_id, drop_type, actions, transactions;
