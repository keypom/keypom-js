...
var KeyPair = nearAPI.KeyPair, parseNearAmount = nearAPI.utils.format.parseNearAmount;
...
var claim = function (_a) {
    ...
    var _b = (0, keypom_1.getEnv)(), networkId = _b.networkId, keyStore = _b.keyStore, attachedGas = _b.attachedGas, contractId = _b.contractId, contractAccount = _b.contractAccount, receiverId = _b.receiverId, execute = _b.execute;
