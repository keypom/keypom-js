...
var claim = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _b, networkId, keyStore, attachedGas, contractId, contractAccount, receiverId, execute, fundingAccountDetails, near, keyPair, dropInfo, keyInfo, curMethodData, transactions, result;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    dropInfo = _c.sent();
                    return [4 /*yield*/, (0, views_1.getKeyInformation)({ secretKey: secretKey })];
                case 3:
                    keyInfo = _c.sent();
                    if (!fcArgs) return [3 /*break*/, 5];
