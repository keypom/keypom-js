...
var addToBalance = function (_a) {
    var account = _a.account, wallet = _a.wallet, amount = _a.amount, absoluteAmount = _a.absoluteAmount;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    (0, checks_1.assert)(receiverId, 'Please call initKeypom before calling this function.');
                ...
                case 1:
                    account = _c.sent();
                    deposit = absoluteAmount || '0';
                    if (amount) {
                        deposit = (0, format_1.parseNearAmount)(amount.toString()) || "0";
                    }
                    actions = [];
                    actions.push({
                        type: 'FunctionCall',
