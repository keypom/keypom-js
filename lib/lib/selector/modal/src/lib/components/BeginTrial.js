        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, keypom_utils_1.accountExists)(actualAccountId)];
                case 1:
                    exists = _e.sent();
                    if (exists) {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    userFcArgs = {
                        ...
                        INSERT_TRIAL_PUBLIC_KEY: (0, keypom_utils_1.getPubFromSecret)(secretKey),
                    };
                    fcArgs[0] = JSON.stringify(userFcArgs);
                    return [4 /*yield*/, (0, claims_1.claim)({ accountId: accountId, secretKey: secretKey, fcArgs: fcArgs })];
                case 2:
                    _a.sent();
