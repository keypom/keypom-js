...
var AccountFormAccountId_1 = __importDefault(require("./AccountFormAccountId"));
...
var BeginTrial = function (_a) {
    ...
    var _j = (0, react_1.useState)(""), accountId = _j[0], setAccountId = _j[1];
    var _k = (0, react_1.useState)(false), isClaimingTrial = _k[0], setIsClaimingTrial = _k[1];
    var _l = (0, react_1.useState)(false), dropClaimed = _l[0], setDropClaimed = _l[1];
    var _m = (0, react_1.useState)(true), validAccountName = _m[0], setValidAccountName = _m[1];
    var _o = (0, react_1.useState)(false), doesAccountExist = _o[0], setDoesAccountExist = _o[1];
    ...
    if (!dropClaimed && !isClaimingTrial) {
        return (react_1.default.createElement("div", { className: "nws-modal", style: { width: "100%", height: "auto", maxWidth: "500px" } },
            react_1.default.createElement("div", { className: "modal-right", style: { width: "100%" } },
                ...
                react_1.default.createElement(AccountFormAccountId_1.default, { handleChange: handleChange, type: 'create', pattern: /[^a-zA-Z0-9_-]/, checkAvailability: checkNewAccount, accountId: accountId, defaultAccountId: "foobar", autoFocus: true, accountIdSuffix: accountSuffix }))));
    }
    // Claiming modal - drop is not claimed and we're in the process of claiming
    if (isClaimingTrial) {
        return (react_1.default.createElement("div", { className: "nws-modal", style: { width: "100%", height: "auto", maxWidth: "500px" } },
            react_1.default.createElement("div", { className: "modal-right", style: { width: "100%" } },
                react_1.default.createElement(MainBody_1.MainBody, { title: ((_d = customizations === null || customizations === void 0 ? void 0 : customizations.claiming) === null || _d === void 0 ? void 0 : _d.title) ||
                        modal_types_1.MODAL_DEFAULTS.beginTrial.claiming.title, body: ((_e = customizations === null || customizations === void 0 ? void 0 : customizations.claiming) === null || _e === void 0 ? void 0 : _e.body) ||
    ...
    return (react_1.default.createElement("div", { className: "nws-modal", style: { width: "100%", height: "auto", maxWidth: "500px" } },
        react_1.default.createElement("div", { className: "modal-right", style: { width: "100%" } },
            react_1.default.createElement(MainBody_1.MainBody, { title: ((_f = customizations === null || customizations === void 0 ? void 0 : customizations.claimed) === null || _f === void 0 ? void 0 : _f.title) ||
                    modal_types_1.MODAL_DEFAULTS.beginTrial.claimed.title, body: ((_g = customizations === null || customizations === void 0 ? void 0 : customizations.claimed) === null || _g === void 0 ? void 0 : _g.body) ||
                    modal_types_1.MODAL_DEFAULTS.beginTrial.claimed.body, imageOne: null, imageTwo: null, button: {
                    text: ((_h = customizations === null || customizations === void 0 ? void 0 : customizations.claimed) === null || _h === void 0 ? void 0 : _h.buttonText) ||
