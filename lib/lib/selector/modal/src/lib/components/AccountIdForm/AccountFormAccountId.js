...
var LocalAlertBox_1 = __importDefault(require("./LocalAlertBox"));
...
var AccountFormAccountId = /** @class */ (function (_super) {
    ...
    function AccountFormAccountId() {
        ...
        _this.updateSuffix = function (userValue) {
            ...
            _this.suffix.current.style.left = width + extraSpace + "px";
        ...
        _this.isImplicitAccount = function (accountId) {
            return _this.props.type !== "create" && accountId.length === 64;
        };
        return _this;
    }
    ...
    AccountFormAccountId.prototype.render = function () {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(InputWrapper, { className: (0, utils_1.classNames)([
                    type,
                    { success: success },
                    { problem: problem },
                ...
                react_1.default.createElement("input", { name: "accountId", "data-test-id": "createAccount.accountIdInput", value: accountId, onInput: function (e) {
                    ...
                    }, placeholder: "placeholder", required: true, autoComplete: "off", autoCorrect: "off", autoCapitalize: "off", spellCheck: "false", tabIndex: "1", autoFocus: autoFocus && accountId.length === 0, disabled: disabled }),
                react_1.default.createElement("span", { className: "input-suffix", ref: this.suffix },
                    ".",
                    this.props.accountIdSuffix),
                type !== "create" && (react_1.default.createElement("div", { className: "input-sub-label" }, translate("input.accountId.subLabel")))),
            react_1.default.createElement(LocalAlertBox_1.default, { dots: mainLoader, localAlert: localAlert, accountId: this.props.accountId })));
    };
...
AccountFormAccountId.propTypes = {
    ...
    placeholder: prop_types_1.default.string.isRequired,
