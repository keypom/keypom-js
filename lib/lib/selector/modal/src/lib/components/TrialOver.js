    ...
    return (react_1.default.createElement("div", { className: "nws-modal" },
        ...
        react_1.default.createElement("div", { className: "modal-right" },
            react_1.default.createElement("div", { className: "nws-modal-body" },
                react_1.default.createElement(MainBody_1.MainBody, { title: mainTitle || modal_types_1.MODAL_DEFAULTS.trialOver.mainBody.title, body: mainBody || modal_types_1.MODAL_DEFAULTS.trialOver.mainBody.body, headerOne: headerOne || modal_types_1.MODAL_DEFAULTS.trialOver.mainBody.headerOne, headerTwo: headerTwo || modal_types_1.MODAL_DEFAULTS.trialOver.mainBody.headerTwo, button: button, onCloseModal: function () {
                        return hide();
                    } })))));
};
