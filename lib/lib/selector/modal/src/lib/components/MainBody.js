    ...
    return (react_1.default.createElement("div", { className: "wallet-home-wrapper" },
        react_1.default.createElement("div", { className: "nws-modal-header-wrapper" },
            react_1.default.createElement("div", { className: "nws-modal-header" },
                ...
                react_1.default.createElement(CloseButton_1.CloseButton, { onClick: onCloseModal }))),
        react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement("div", { className: "wallet-info-wrapper what-wallet-hide" },
                headerOne && (react_1.default.createElement("div", { className: "wallet-what" },
                    ...
                    react_1.default.createElement("div", { className: "content-side" },
                        react_1.default.createElement("h3", null, (headerOne === null || headerOne === void 0 ? void 0 : headerOne.title) || modal_1.MODAL_DEFAULTS.trialOver.mainBody.headerOne.title),
                        react_1.default.createElement("p", null, (headerTwo === null || headerTwo === void 0 ? void 0 : headerTwo.description) || modal_1.MODAL_DEFAULTS.trialOver.mainBody.headerOne.description)))),
                headerTwo && (react_1.default.createElement("div", { className: "wallet-what" },
                    ...
                    react_1.default.createElement("div", { className: "content-side" },
                        react_1.default.createElement("h3", null, headerTwo.title || modal_1.MODAL_DEFAULTS.trialOver.mainBody.headerTwo.title),
                        react_1.default.createElement("p", null, headerTwo.description || modal_1.MODAL_DEFAULTS.trialOver.mainBody.headerTwo.description)))),
            ...
            button && (react_1.default.createElement("div", { className: "what-wallet-mobile" },
                react_1.default.createElement("button", { className: "middleButton", onClick: function () {
                        window.open(button.url || 'https://keypom.xyz/', '_blank');
                    } }, button.text || "Next Steps"))),
            react_1.default.createElement("div", { className: "lang-selector-wrapper" },
                react_1.default.createElement("select", { className: "lang-selector", name: "lang" },
