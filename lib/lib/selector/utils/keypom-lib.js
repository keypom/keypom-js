...
exports.createAction = exports.isUnclaimedTrialDrop = exports.isKeypomDrop = exports.setLocalStorageKeypomEnv = exports.getLocalStorageKeypomEnv = exports.KEYPOM_LOCAL_STORAGE_KEY = exports.networks = void 0;
...
var isKeypomDrop = function (networkId, keypomContractId) {
<<<<<<< HEAD
    if (keypom_1.officialKeypomContracts[networkId][keypomContractId] === true) {
=======
...
exports.isKeypomDrop = isKeypomDrop;
var isUnclaimedTrialDrop = function (networkId, keypomContractId, secretKey) { return __awaiter(void 0, void 0, void 0, function () {
    var keyInfo;
