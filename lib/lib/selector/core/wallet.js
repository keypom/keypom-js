...
var KeypomWallet = /** @class */ (function () {
    function KeypomWallet(_a) {
        var _b = _a.networkId, networkId = _b === void 0 ? "mainnet" : _b, _c = _a.desiredUrl, desiredUrl = _c === void 0 ? "/keypom-trial/" : _c, _d = _a.keyStore, keyStore = _d === void 0 ? new browser_local_storage_key_store_1.BrowserLocalStorageKeyStore() : _d;
        var _this = this;
    ...
    KeypomWallet.prototype.signAndSendTransactions = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var transactions, args, account, incomingGas, gasToAttach, transformedTransactions, promises;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        gasToAttach = new bn_js_1.default('15000000000000').add(new bn_js_1.default(incomingGas)).toString();
