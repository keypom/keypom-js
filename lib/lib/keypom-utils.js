...
exports.estimateRequiredDeposit = exports.getStorageBase = exports.transformTransactions = exports.nftTransferCall = exports.ftTransferCall = exports.execute = exports.genKey = exports.key2str = exports.snakeToCamel = exports.ATTACHED_GAS_FROM_WALLET = void 0;
var nearAPI = require("near-api-js");
var KeyPair = nearAPI.KeyPair, utils = nearAPI.utils, transactions = nearAPI.transactions, _a = nearAPI.utils.format, parseNearAmount = _a.parseNearAmount, formatNearAmount = _a.formatNearAmount;
