...
var getPubFromSecret = function (secretKey) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, KeyPair.fromString(secretKey)];
            case 1:
                keyPair = _a.sent();
...
var formatLinkdropUrl = function (_a) {
    var claimPage = _a.claimPage, networkId = _a.networkId, contractId = _a.contractId, secretKeys = _a.secretKeys, baseUrl = _a.baseUrl;
    ...
    (0, checks_1.assert)(baseUrl || keypom_1.supportedLinkdropClaimPages[networkId].hasOwnProperty(claimPage), "Either a custom base URL or a supported claim page must be passed in.");
    baseUrl = baseUrl || keypom_1.supportedLinkdropClaimPages[networkId][claimPage];
    var returnedURLs = [];
    // loop through all secret keys
    secretKeys.forEach(function (secretKey) {
        returnedURLs.push("".concat(baseUrl, "/").concat(contractId, "/").concat(secretKey));
    });
    return returnedURLs;
};
