 ...
 * @group Utility
*/
var viewAccessKeyData = function (_a) {
    var accountId = _a.accountId, publicKey = _a.publicKey, secretKey = _a.secretKey;
    return __awaiter(void 0, void 0, void 0, function () {
        var near, provider, res;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    near = (0, keypom_1.getEnv)().near;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    console.log('needsRedirect: ', needsRedirect_1);
...
var nearArgsToYocto = function (nearAmount, yoctoAmount) {
    var yoctoToReturn = yoctoAmount || '0';
    if (nearAmount) {
...
var createTransactions = function (_a) {
    var txnInfos = _a.txnInfos, signerId = _a.signerId, signerPk = _a.signerPk;
    var near = (0, keypom_1.getEnv)().near;
    var account = new near_api_js_1.Account(near.connection, signerId);
    var provider = account.connection.provider;
    return Promise.all(txnInfos.map(function (txnInfo, index) { return __awaiter(void 0, void 0, void 0, function () {
        var actions, block, accessKey;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    actions = txnInfo.actions.map(function (action) {
                        return (0, exports.createAction)(action);
                    });
                    console.log("actions: ".concat(JSON.stringify(actions)));
                    return [4 /*yield*/, provider.block({ finality: "final" })];
                case 1:
                    block = _a.sent();
                    console.log("block: ".concat(JSON.stringify(block)));
                    console.log('`access_key/${signerId}/${signerPk}`: ', "access_key/".concat(signerId, "/").concat(signerPk));
                    return [4 /*yield*/, provider.query("access_key/".concat(signerId, "/").concat(signerPk), "")];
                case 2:
                    accessKey = _a.sent();
                    console.log("accessKey: ".concat(JSON.stringify(accessKey)));
                    return [2 /*return*/, near_api_js_1.transactions.createTransaction(signerId, signerPk, txnInfo.receiverId, accessKey.nonce + index + 1, actions, (0, serialize_1.base_decode)(block.header.hash))];
            }
        });
    }); }));
};
