    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                (0, checks_1.assert)(connection, "No connection found. Please call `init` first.");
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
...
var keypomView = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            (0, checks_1.assert)(viewCall, 'initKeypom must be called before view functions can be called.');
