...
exports.generatePerUsePasswords = exports.estimateRequiredDeposit = exports.getStorageBase = exports.transformTransactions = exports.parseFTAmount = exports.nftTransferCall = exports.ftTransferCall = exports.execute = exports.keypomView = exports.getUserBalance = exports.generateKeys = exports.hashPassword = exports.key2str = exports.snakeToCamel = exports.ATTACHED_GAS_FROM_WALLET = exports.exportedNearAPI = void 0;
...
var nftTransferCall = function (_a) {
    var account = _a.account, wallet = _a.wallet, contractId = _a.contractId, receiverId = _a.receiverId, tokenIds = _a.tokenIds, msg = _a.msg, _b = _a.returnTransactions, returnTransactions = _b === void 0 ? false : _b;
    return __awaiter(void 0, void 0, void 0, function () {
        var getAccount, responses, transactions, i, tx, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    getAccount = (0, keypom_1.getEnv)().getAccount;
...
var getStorageBase = function (_a) {
    ...
    if (typeof window === 'undefined') {
        ...
        var bytesForDeposit = Buffer.from(deposit_per_use.toString()).length;
        console.log('bytesForDeposit: ', bytesForDeposit);
        // Bytes for the drop ID
        var bytesForDropId = Buffer.from(drop_id || "").length;
        console.log('bytesForDropId: ', bytesForDropId);
        // Bytes for the config
        var bytesForConfig = Buffer.from(JSON.stringify(config || "")).length;
        console.log('bytesForConfig: ', bytesForConfig);
        // Bytes for the metadata
        var bytesForMetadata = Buffer.from(metadata || "").length;
        console.log('bytesForMetadata: ', bytesForMetadata);
        // Bytes for the simple data
        var bytesForSimple = Buffer.from(JSON.stringify(simple || "")).length;
        console.log('bytesForSimple: ', bytesForSimple);
        // Bytes for the FT data
        var bytesForFT = Buffer.from(JSON.stringify(ft || "")).length;
        console.log('bytesForFT: ', bytesForFT);
        // Bytes for the NFT data
        var bytesForNFT = Buffer.from(JSON.stringify(nft || "")).length;
        console.log('bytesForNFT: ', bytesForNFT);
        // Bytes for the FC data
        var bytesForFC = Buffer.from(JSON.stringify(fc || "")).length;
        console.log('bytesForFC: ', bytesForFC);
        // Bytes for the passwords per use
        var bytesForPasswords = Buffer.from(JSON.stringify(passwords_per_use || "")).length;
    ...
    var totalNEARAmount = (totalBytes * storageCostNEARPerByte).toString();
