...
exports.nearArgsToYocto = exports.genArgs = exports.wrapParams = exports.toCamel = exports.snakeToCamel = exports.generatePerUsePasswords = exports.estimateRequiredDeposit = exports.getStorageBase = exports.transformTransactions = exports.parseFTAmount = exports.nftTransferCall = exports.ftTransferCall = exports.execute = exports.viewAccessKeyData = exports.keypomView = exports.generateKeys = exports.hashPassword = exports.formatLinkdropUrl = exports.createNFTSeries = exports.getFTMetadata = exports.getNFTMetadata = exports.accountExists = exports.getPubFromSecret = exports.key2str = exports.ATTACHED_GAS_FROM_WALLET = exports.exportedNearAPI = void 0;
...
var genArgs = function (json) {
    ...
    json.transactions.forEach(function (tx) {
        ...
        tx.actions.forEach(function (action) {
            ...
            newAction.params = (0, exports.wrapParams)(action.params);
