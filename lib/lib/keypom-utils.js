...
var getUserBalance = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            (0, checks_1.assert)(viewAccount, 'initKeypom must be called before view functions can be called.');
...
var ftTransferCall = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _c, getAccount, near, keypomContractId, viewAccount, metadata, tx;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _c = (0, keypom_1.getEnv)(), getAccount = _c.getAccount, near = _c.near, keypomContractId = _c.receiverId, viewAccount = _c.viewAccount;
