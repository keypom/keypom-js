        ...
        return __generator(this, function (_x) {
            switch (_x.label) {
                ...
                case 7:
                    ...
                    attachedDeposit = new bn_js_1.default(startingBalanceYocto).add(new bn_js_1.default(parseNearAmount("0.3"))).toString();
                        ...
                        fc: {
                            methods: [[
                                    ...
                                    },
                                    {
                                        ...
                                        //@ts-ignore
                                        attached_deposit: '0',
                                        args: JSON.stringify((0, keypom_utils_1.wrapParams)({
