        ...
        return __generator(this, function (_x) {
            switch (_x.label) {
                ...
                case 1:
                    ...
                    (0, checks_1.assert)(callableMethods.length === callableContracts.length && callableMethods.length === maxAttachableDepositPerContract.length, 'The length of the callable methods, contracts, and max attachable deposit per contract must all be the same.');
