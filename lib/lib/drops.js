...
<<<<<<< HEAD
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _g, near, viewAccount, gas, attachedGas, contractId, receiverId, getAccount, execute, fundingAccount, fundingAccountDetails, finalConfig, keys, rootEntropyUsed, nonceDropIdMeta, passwords, ftBalancePerUse, metadata_1, createDropArgs, storageCalculated, requiredDeposit, hasBalance, userBal, deposit, transactions, _h, _j, tokenIds, nftTXs, responses;
        var _k, _l, _m, _o;
        return __generator(this, function (_p) {
            switch (_p.label) {
                case 0:
                    _g = (0, keypom_1.getEnv)(), near = _g.near, viewAccount = _g.viewAccount, gas = _g.gas, attachedGas = _g.attachedGas, contractId = _g.contractId, receiverId = _g.receiverId, getAccount = _g.getAccount, execute = _g.execute, fundingAccount = _g.fundingAccount, fundingAccountDetails = _g.fundingAccountDetails;
=======
    var account = _a.account, wallet = _a.wallet, dropId = _a.dropId, _b = _a.numKeys, numKeys = _b === void 0 ? 0 : _b, publicKeys = _a.publicKeys, rootEntropy = _a.rootEntropy, depositPerUseNEAR = _a.depositPerUseNEAR, depositPerUseYocto = _a.depositPerUseYocto, metadata = _a.metadata, _c = _a.config, config = _c === void 0 ? {} : _c, _d = _a.ftData, ftData = _d === void 0 ? {} : _d, _e = _a.nftData, nftData = _e === void 0 ? {} : _e, _f = _a.simpleData, simpleData = _f === void 0 ? {} : _f, fcData = _a.fcData, basePassword = _a.basePassword, passwordProtectedUses = _a.passwordProtectedUses, _g = _a.useBalance, useBalance = _g === void 0 ? false : _g, _h = _a.returnTransactions, returnTransactions = _h === void 0 ? false : _h, successUrl = _a.successUrl;
    return __awaiter(void 0, void 0, void 0, function () {
        var _j, near, viewAccount, gas, attachedGas, contractId, receiverId, getAccount, execute, fundingAccountDetails, finalConfig, keys, rootEntropyUsed, nonceDropIdMeta, passwords, ftBalancePerUse, metadata_1, createDropArgs, storageCalculated, requiredDeposit, hasBalance, userBal, deposit, transactions, _k, _l, tokenIds, nftTXs, responses;
        var _m, _o, _p, _q;
        return __generator(this, function (_r) {
            switch (_r.label) {
                case 0:
                    _j = (0, keypom_1.getEnv)(), near = _j.near, viewAccount = _j.viewAccount, gas = _j.gas, attachedGas = _j.attachedGas, contractId = _j.contractId, receiverId = _j.receiverId, getAccount = _j.getAccount, execute = _j.execute, fundingAccountDetails = _j.fundingAccountDetails;
>>>>>>> main
...
<<<<<<< HEAD
                case 11:
                    requiredDeposit = _p.sent();
=======
                case 12:
                    requiredDeposit = _r.sent();
>>>>>>> main
                    hasBalance = false;
                    if (!useBalance) return [3 /*break*/, 14];
...
=======
                    if (!((ftData === null || ftData === void 0 ? void 0 : ftData.contractId) && (publicKeys === null || publicKeys === void 0 ? void 0 : publicKeys.length))) return [3 /*break*/, 16];
                    _l = (_k = transactions).push;
>>>>>>> main
...
<<<<<<< HEAD
                    if (!(nftData && tokenIds && (tokenIds === null || tokenIds === void 0 ? void 0 : tokenIds.length) > 0)) return [3 /*break*/, 17];
=======
                    if (!(tokenIds && (tokenIds === null || tokenIds === void 0 ? void 0 : tokenIds.length) > 0)) return [3 /*break*/, 18];
>>>>>>> main
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    drops = _d.sent();
                    _d.label = 3;
                case 3: return [4 /*yield*/, Promise.all(drops.map(function (_a) {
