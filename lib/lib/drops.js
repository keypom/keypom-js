...
var createDrop = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _h, near, viewAccount, gas, attachedGas, contractId, receiverId, getAccount, execute, fundingAccount, fundingAccountDetails, finalConfig, keys, rootEntropyUsed, nonceDropIdMeta, passwords, ftBalancePerUse, metadata_1, createDropArgs, storageCalculated, requiredDeposit, hasBalance, userBal, deposit, transactions, tokenIds, nftTXs, responses;
        var _j, _k, _l, _m;
                    ...
                    if ((ftData === null || ftData === void 0 ? void 0 : ftData.contractId) && (publicKeys === null || publicKeys === void 0 ? void 0 : publicKeys.length)) {
                        transactions.push((0, keypom_utils_1.ftTransferCall)({
                            ...
                            args: {
                                ...
                                amount: new bn_js_1.default(ftBalancePerUse).mul(new bn_js_1.default(publicKeys.length)).toString(),
                                msg: dropId.toString(),
                            },
