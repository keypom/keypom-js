...
<<<<<<< HEAD
        ...
        return __generator(this, function (_0) {
            switch (_0.label) {
=======
        var _g, near, viewAccount, networkId, gas, attachedGas, contractId, receiverId, getAccount, execute, fundingAccountDetails, finalConfig, keys, rootEntropyUsed, nonceDropIdMeta, passwords, ftBalancePerUse, metadata_1, createDropArgs, storageCalculated, requiredDeposit, hasBalance, userBal, deposit, transactions, _h, _j, tokenIds, nftTXs, responses;
        var _k, _l, _m, _o, _p;
...
=======
                    account = _q.sent();
>>>>>>> main
                    (0, checks_1.assert)(keypom_1.supportedKeypomContracts[networkId][contractId] === true, "Only the latest Keypom contract can be used to call this methods. Please update the contract to: v1-3.keypom.near or v1-3.keypom.testnet");
                    /// parse args
...
>>>>>>> main
                    finalConfig = {
                        ...
                        sale: (config === null || config === void 0 ? void 0 : config.sale) ? {
                            max_num_keys: (_p = config === null || config === void 0 ? void 0 : config.sale) === null || _p === void 0 ? void 0 : _p.maxNumKeys,
                            price_per_key: ((_q = config === null || config === void 0 ? void 0 : config.sale) === null || _q === void 0 ? void 0 : _q.pricePerKeyYocto) || ((_r = config === null || config === void 0 ? void 0 : config.sale) === null || _r === void 0 ? void 0 : _r.pricePerKeyNEAR) ? parseNearAmount((_t = (_s = config === null || config === void 0 ? void 0 : config.sale) === null || _s === void 0 ? void 0 : _s.pricePerKeyNEAR) === null || _t === void 0 ? void 0 : _t.toString()) : undefined,
                            allowlist: (_u = config === null || config === void 0 ? void 0 : config.sale) === null || _u === void 0 ? void 0 : _u.allowlist,
                            blocklist: (_v = config === null || config === void 0 ? void 0 : config.sale) === null || _v === void 0 ? void 0 : _v.blocklist,
                            auto_withdraw_funds: (_w = config === null || config === void 0 ? void 0 : config.sale) === null || _w === void 0 ? void 0 : _w.autoWithdrawFunds,
                            start: (_x = config === null || config === void 0 ? void 0 : config.sale) === null || _x === void 0 ? void 0 : _x.start,
                            end: (_y = config === null || config === void 0 ? void 0 : config.sale) === null || _y === void 0 ? void 0 : _y.end
                        } : undefined,
                    ...
                    createDropArgs = {
                        ...
                        fc: (fcData === null || fcData === void 0 ? void 0 : fcData.methods) ? ({
                            config: fcData.config ? ({
                                attached_gas: (_p = fcData.config) === null || _p === void 0 ? void 0 : _p.attachedGas,
                            }) : undefined,
                            ...
                            config: fcData.config ? {
                                attached_gas: (_z = fcData.config) === null || _z === void 0 ? void 0 : _z.attachedGas
                            } : undefined
                        }) : undefined,
