...
var createDrop = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _j, near, viewAccount, gas, attachedGas, contractId, receiverId, getAccount, execute, fundingAccount, fundingAccountDetails, finalConfig, keys, rootEntropyUsed, nonceDropIdMeta, passwords, ftBalancePerUse, metadata_1, createDropArgs, storageCalculated, requiredDeposit, hasBalance, userBal, deposit, transactions, _k, _l, tokenIds, nftTXs, responses;
        var _m, _o, _p, _q;
        return __generator(this, function (_r) {
            switch (_r.label) {
                case 0:
                    _j = (0, keypom_1.getEnv)(), near = _j.near, viewAccount = _j.viewAccount, gas = _j.gas, attachedGas = _j.attachedGas, contractId = _j.contractId, receiverId = _j.receiverId, getAccount = _j.getAccount, execute = _j.execute, fundingAccount = _j.fundingAccount, fundingAccountDetails = _j.fundingAccountDetails;
