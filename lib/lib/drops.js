...
var createDrop = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _f, near, viewAccount, gas, attachedGas, contractId, receiverId, getAccount, execute, finalConfig, requiredDeposit, metadata_1, transactions, responses, tokenIds, nftResponses;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 4:
                    ...
                    if (!(tokenIds && (tokenIds === null || tokenIds === void 0 ? void 0 : tokenIds.length) > 0)) return [3 /*break*/, 6];
                ...
                case 5:
                    ...
                    _g.label = 6;
                case 6: return [2 /*return*/, { responses: responses }];
            }
        });
    });
};
