...
var createDrop = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _h, near, viewAccount, gas, attachedGas, contractId, receiverId, getAccount, execute, fundingAccount, fundingAccountDetails, finalConfig, keys, rootEntropyUsed, nonceDropIdMeta, passwords, createDropArgs, requiredDeposit, hasBalance, userBal, metadata_1, deposit, transactions, tokenIds, nftTXs, responses;
        var _j, _k, _l, _m;
            ...
            switch (_o.label) {
                ...
                case 7:
                    ...
                    return [4 /*yield*/, (0, keypom_utils_1.estimateRequiredDeposit)({
                            ...
                            storage: (0, keypom_utils_1.getStorageBase)(createDropArgs),
                            ftData: ftData,
                            fcData: fcData,
                        })];
                case 8:
