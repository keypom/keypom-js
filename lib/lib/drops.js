...
var createDrop = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _f, near, viewAccount, gas, attachedGas, contractId, receiverId, getAccount, execute, finalConfig, requiredDeposit, metadata_1, deposit, transactions, tokenIds, nftTXs, responses;
        var _g, _h, _j, _k;
        return __generator(this, function (_l) {
            switch (_l.label) {
                case 0:
                    _f = (0, keypom_1.getEnv)(), near = _f.near, viewAccount = _f.viewAccount, gas = _f.gas, attachedGas = _f.attachedGas, contractId = _f.contractId, receiverId = _f.receiverId, getAccount = _f.getAccount, execute = _f.execute;
                    ...
                    finalConfig = {
                        ...
                        root_account_id: config === null || config === void 0 ? void 0 : config.rootAccountId,
                        usage: {
                            ...
                            return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_h) {
                                    switch (_h.label) {
                                        case 0:
                                            responses = [];
                                            if (!(registered_uses !== 0 && (ft !== undefined || nft !== undefined))) return [3 /*break*/, 2];
