...
var createDrop = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _h, near, viewAccount, gas, attachedGas, contractId, receiverId, getAccount, execute, fundingAccount, fundingAccountDetails, finalConfig, keys, rootEntropyUsed, nonceDropIdMeta, passwords, requiredDeposit, hasBalance, userBal, metadata_1, deposit, transactions, tokenIds, nftTXs, responses;
        var _j, _k, _l, _m;
        return __generator(this, function (_o) {
            switch (_o.label) {
                ...
                case 5:
                    ...
                    if (!basePassword) return [3 /*break*/, 7];
                    return [4 /*yield*/, (0, keypom_utils_1.generatePerUsePasswords)({
                            publicKeys: publicKeys,
                            basePassword: basePassword,
                            uses: passwordProtectedUses || Array.from({ length: numKeys }, function (_, i) { return i + 1; })
                        })];
                case 6:
                    ...
                    passwords = _o.sent();
                    _o.label = 7;
                case 7: return [4 /*yield*/, (0, keypom_utils_1.estimateRequiredDeposit)({
                        near: near,
                ...
                case 9:
                    ...
                    _o.label = 10;
                case 10:
                    if (!(ftData === null || ftData === void 0 ? void 0 : ftData.balancePerUse)) return [3 /*break*/, 12];
                ...
                case 12:
                    ...
                    if (!(tokenIds && (tokenIds === null || tokenIds === void 0 ? void 0 : tokenIds.length) > 0)) return [3 /*break*/, 14];
                ...
                case 13:
                    ...
                    _o.label = 14;
                case 14: return [4 /*yield*/, execute({ transactions: transactions, account: account, wallet: wallet })];
                case 15:
                    responses = _o.sent();
