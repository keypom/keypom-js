...
var createDrop = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _h, near, viewAccount, gas, attachedGas, contractId, receiverId, getAccount, execute, fundingAccount, fundingAccountDetails, dropInfo, _1, finalConfig, keys, rootEntropyUsed, nonceDropIdMeta, passwords, ftBalancePerUse, metadata_1, createDropArgs, storageCalculated, requiredDeposit, hasBalance, userBal, deposit, transactions, tokenIds, nftTXs, responses;
        var _j, _k, _l, _m;
        return __generator(this, function (_o) {
            switch (_o.label) {
                ...
                case 2:
                    dropInfo = _o.sent();
                    (0, checks_1.assert)(!dropInfo, "Drop with ID ".concat(dropId, " already exists. Please use a different drop ID."));
                    return [3 /*break*/, 4];
                case 3:
                    _1 = _o.sent();
                    return [3 /*break*/, 4];
                case 4:
                    ...
                    if (!!publicKeys) return [3 /*break*/, 9];
                    ...
                    if (!rootEntropyUsed) return [3 /*break*/, 6];
                ...
                case 5:
                    keys = _o.sent();
                    return [3 /*break*/, 8];
                case 6: return [4 /*yield*/, (0, keypom_utils_1.generateKeys)({
                        numKeys: numKeys,
                    })];
                case 7:
                ...
                case 9:
                    ...
                    if (!basePassword) return [3 /*break*/, 11];
                    ...
                    if ((ftData === null || ftData === void 0 ? void 0 : ftData.contractId) && (publicKeys === null || publicKeys === void 0 ? void 0 : publicKeys.length)) {
                        transactions.push((0, keypom_utils_1.ftTransferCall)({
                            ...
                            args: {
                                ...
                                amount: new bn_js_1.default(ftBalancePerUse).mul(new bn_js_1.default(numKeys)).mul(new bn_js_1.default(finalConfig.uses_per_key)).toString(),
                                msg: dropId.toString(),
                            },
                ...
                case 17:
                    ...
                    _o.label = 18;
                case 18: return [4 /*yield*/, execute({ transactions: transactions, account: account, wallet: wallet })];
                case 19:
                    responses = _o.sent();
