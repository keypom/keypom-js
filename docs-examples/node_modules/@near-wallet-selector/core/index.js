...
var modal$7 = {
	...
	exportAccounts: {
		...
		complete: {
			...
			desc: "You will now be redirected to the wallet you selected to complete the transfer. Once import part of process is completed from selected wallet, press button to complete the transfer process.",
			button: "Complete"
		}
	}
};
...
export { getActiveAccount, setupWalletSelector, translate, waitFor };
