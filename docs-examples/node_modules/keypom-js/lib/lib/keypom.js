...
exports.updateKeypomContractId = exports.updateFunder = exports.initKeypom = exports.execute = exports.getEnv = exports.supportedKeypomContracts = void 0;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    _c.label = 2;
                case 2:
                    returnedAccount = _b || fundingAccount;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    if (keypomContractId) {
                        (0, checks_1.assert)(officialKeypomContracts[networkId][keypomContractId] === true, "The keypom contract passed in must be an official Keypom contract for the given network.");
