...
function MyForm(_a) {
    var _this = this;
    var onSubmit = _a.onSubmit, hide = _a.hide;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, onSubmit(accountId)];
                case 1:
                    _a.sent();
                    hide();
                    return [2 /*return*/];
    ...
    return (react_2.default.createElement("form", { onSubmit: handleSubmit },
        react_2.default.createElement("label", null,
            ...
            react_2.default.createElement("input", { type: "text", value: accountId, onChange: function (e) { return setAccountId(e.target.value); } })),
